...
void BSP_MOTOR_PWM_SET(TIM_TypeDef* timer,uint8_t tim_channel,uint16_t frequency,uint16_t Duty_cycle)
{
	...
	{
		case 1:
				TIM_OC1Init(timer, &TIM_OCInitStructure);	 									//使能通道1
				TIM_OC1PreloadConfig(timer, TIM_OCPreload_Enable);
			break;
		case 2:
				TIM_OC2Init(timer, &TIM_OCInitStructure);	 									//使能通道2
		...
		case 3:
			...
			break;
		case 4:
				TIM_OC4Init(timer, &TIM_OCInitStructure);	 									//使能通道4
...
void BSP_MOTOR_Set_PWM_Pulse(uint8_t channel,uint16_t Duty_cycle)
{
	...
	{
		case 1:
				TIM_OC1Init(BSP_MOTOR_TIM, &TIM_OCInitStructure);	 									//使能通道1
				TIM_OC1PreloadConfig(BSP_MOTOR_TIM, TIM_OCPreload_Enable);
			break;
		case 2:
				TIM_OC2Init(BSP_MOTOR_TIM, &TIM_OCInitStructure);	 									//使能通道2
		...
		case 3:
			...
			break;
		case 4:
				TIM_OC4Init(BSP_MOTOR_TIM, &TIM_OCInitStructure);	 									//使能通道4
